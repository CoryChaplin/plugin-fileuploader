...
<head>
	...
	<!-- Security headers -->
	<meta http-equiv="Content-Security-Policy" content="default-src 'self' https://chat.europnet.org http://www.chat-fr.org http://quote.europnet.org; script-src 'unsafe-inline' https://www.googletagmanager.com https://cdn.jsdelivr.net https://cmp.gatekeeperconsent.com https://the.gatekeeperconsent.com https://privacy.gatekeeperconsent.com https://www.ezojs.com https://go.ezodn.com https://cdn.id5-sync.com; style-src 'unsafe-inline' https://cdnjs.cloudflare.com; media-src 'self'; img-src 'self' data: https:; font-src https://cdnjs.cloudflare.com; connect-src https:; frame-src https:;">
